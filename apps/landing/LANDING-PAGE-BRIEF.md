...
- School variants: forked repos with custom themes (e.g. partille.lektionsvy.se)

## File References

All design assets live in the classroom-screen repo:
- Default theme: `src/themes/default/`
- PG theme (reference): `src/themes/partille-gymnasium/`
- Theme config type: `src/themes/default/config.ts`
